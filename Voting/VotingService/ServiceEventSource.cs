...
namespace VotingService
{
    ...
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "Service request '{0}' started. Activity : {1}", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "Service request '{0}' finished. Activity : {1}", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestFailedEventId, Level = EventLevel.Error, Message = "Service request '{0}' failed. Activity : {1}", Keywords = Keywords.Requests)]
        public void ServiceRequestFailed(string requestTypeName, string exception, string activityId)
        {
